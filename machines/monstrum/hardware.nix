{
  ...
  boot = {
    ...
    initrd = {
      availableKernelModules = ["ahci" "xhci_pci" "ata_generic" "ehci_pci" "nvme" "usbhid" "usb_storage" "sd_mod" "sr_mod"];
  ...
  fileSystems = {
    ...
    "/var/home/k/Downloads" = {
      device = "/var/media/downloads/k";
      fsType = "none";
      options = ["bind"];
    };
    "/var/home/m/Downloads" = {
      device = "/var/media/downloads/m";
      fsType = "none";
      options = ["bind"];
    };
    "/var/home/km/Downloads" = {
